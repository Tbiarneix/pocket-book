...
const fieldClasses =
  "min-h-10 rounded-[8px] border border-border-field bg-surface px-3 text-sm text-foreground";
  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <h1 className="font-serif text-2xl font-semibold text-foreground">Bibliothèque</h1>

        <div className="flex gap-2.5">
          <div
            role="group"
            aria-label="Mode d'affichage"
            className="flex overflow-hidden rounded-[8px] border border-border-strong"
          >
            <button
              type="button"
            ...
            <button
              ...
              className={`flex h-11 w-11 items-center justify-center border-l border-border-strong ${
          ...
          <Link
            href="/library/new"
            className="inline-flex min-h-11 items-center gap-1.5 rounded-[8px] bg-accent px-4 text-sm font-semibold text-accent-foreground hover:opacity-90"
          >
      ...
      {reference && (
        <fieldset className="flex flex-wrap items-end gap-4 rounded-[10px] border border-border bg-surface p-4">
          <legend className="px-1 text-[13px] font-semibold text-foreground">
            Filtrer la bibliothèque
          </legend>

          <div className="flex flex-col gap-1.5">
            <label htmlFor={searchId} className="text-[12.5px] font-semibold text-muted">
              Titre ou auteur·rice
            </label>
            <div className="flex w-56 items-center gap-1.5 rounded-[8px] border border-border-field px-2.5">
              ...
              <input
                ...
                className="min-h-10 w-full bg-transparent text-sm text-foreground outline-none"
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor={statusId} className="text-[12.5px] font-semibold text-muted">
              Statut
            </label>
            <select
              id={statusId}
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor={genreId} className="text-[12.5px] font-semibold text-muted">
              Genre
            </label>
            <select
              id={genreId}
          ...
          <div className="flex flex-col gap-1.5">
            <label htmlFor={seriesId} className="text-[12.5px] font-semibold text-muted">
              Série
            </label>
            <select
              id={seriesId}
          ...
          {hasActiveFilters ? (
            <button
              ...
              className="min-h-10 rounded-[8px] border border-border-strong px-3 text-sm font-semibold text-foreground hover:bg-surface-muted"
            >
              Réinitialiser
            </button>
          ) : null}
